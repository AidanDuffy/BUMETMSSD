...
//	private int size = 0; // number of nodes in the tree
	...
	// nonpublic utility
	/**
	 * Verifies that a Node belongs to the appropriate class, and is not one
	 ...
	 */
	/*
	 * protected Node<E> validate(Node<E> p) throws IllegalArgumentException { if
	 * (!(p instanceof Node)) throw new
	 * IllegalArgumentException("Not valid position type"); Node<E> node = (Node<E>)
	 * p; // safe cast if (node.getParent() == node) // our convention for defunct
	 * node throw new IllegalArgumentException("p is no longer in the tree"); return
	 * node; }
	 */
